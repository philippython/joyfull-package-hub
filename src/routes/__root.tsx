...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Rewindd — Date Night Ritual Kit" },
      { property: "og:description", content: "Pause. Connect. Reignite. A premium kit for the couples who still love each other deeply." },
