...
export const Route = createFileRoute("/kit")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Choose your Rewindd date night kit. Hand-packed, UK delivery, dispatched in 2–3 business days." },
      { property: "og:title", content: "Rewindd — Date Night Kits" },
      { property: "og:description", content: "Browse our intentional, hand-packed date night kits for couples." },
    ],
  }),
    ...
    <SiteLayout>
      <section className="bg-charcoal text-cream pt-36 pb-20 px-6 text-center">
        ...
        <p className="mt-6 text-cream/70 text-sm md:text-base max-w-xl mx-auto leading-relaxed">
          Every kit is hand-packed and designed to help busy couples slow down and reconnect — all from the comfort of home.
        </p>
      </section>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <span className="text-[11px] tracking-[0.2em] uppercase text-gold group-hover:text-burgundy transition">View →</span>
                    </div>
                  </div>
                </Link>
              ))}
