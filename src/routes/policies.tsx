  ...
  head: () => ({
    meta: [
      { title: "Shipping, Returns & Care — Rewindd" },
      {
        name: "description",
        content:
          "Rewindd dispatches within 2–3 business days. UK delivery only. 14-day returns and a 48-hour damage reporting window.",
      },
      { property: "og:title", content: "Rewindd — Shipping, Returns & Care" },
      {
        property: "og:description",
        content: "Everything you need to know about shipping, returns and damaged orders.",
      },
    ],
  }),
          ...
          <Card
            ...
            body={
              <>
                ...
                <strong>48 hours of delivery</strong> with photos of the item and packaging at{" "}
                <a
                  href="mailto:rewindd2026@gmail.com"
                  className="text-burgundy underline underline-offset-2 hover:text-gold"
                >
