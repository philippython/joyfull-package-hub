...
export const Route = createFileRoute("/policies")({
  head: () => ({
    meta: [
      { title: "Shipping, Returns & Care — Rewindd" },
      { name: "description", content: "Rewindd dispatches within 2–3 business days. UK delivery only. 14-day returns and a 48-hour damage reporting window." },
      { property: "og:title", content: "Rewindd — Shipping, Returns & Care" },
      { property: "og:description", content: "Everything you need to know about shipping, returns and damaged orders." },
    ],
  }),
    ...
    <SiteLayout>
      ...
      <section className="bg-ivory py-20 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
          ...
          <Card title="UK Delivery Only"
            body="At this time, Rewindd is available for delivery within the United Kingdom only." />
          <Card title="Returns (14 Days)"
            body="We accept returns within 14 days of delivery. Items must be returned in their original condition. The buyer is responsible for the return shipping fee. For hygiene reasons, the massage oil seal must remain unopened and unbroken." />
          <Card title="Damaged on Arrival" body={(
            <>
          ...
          <Card title="Changing or Cancelling an Order"
